# MUSINSA Personal Shopper Plugin — 상세 운영/기술 문서

> 이 문서는 README를 핵심 중심으로 줄이면서 뒤편으로 분리한 상세 설명입니다. 원본 README의 아키텍처, API, OpenCrab, analytics, dashboard, 제출 자료, 한계/확장 내용을 보존합니다.
...
|---|---|---|
| MUSINSA product DB ontology | 2,050개 상품 데이터, 링크, 이미지 URL, 가격/리뷰/소재/핏 신호 | `0b3c79f7-1861-4466-ba20-2cbaa736de66` / v3.8.0 |
